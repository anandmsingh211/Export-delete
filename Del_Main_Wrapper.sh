#!/bin/ksh
#################################################################################
# Description: Wrapper script to execute EXP_DEL_VAL_1.sql
# Changes:
...
@EXP_DEL_VAL_1.sql "$ORACLE_DB" "$FROM_DATE" "$TO_DATE" "$LOG_DIR_OBJ" "$LOG_FILE_NAME" "$CLAUSE_TO_SQLPLUS"
EXIT;
EOF
