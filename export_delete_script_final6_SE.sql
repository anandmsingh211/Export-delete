...
spool c:\temp\export_delete_script_final6_SE.LOG
set echo on
set autocommit off
set feedback on
set time on
...
-- **********************************************************************
-- SQL Script File Name: export_delete_script_final6_SE.SQL
-- **********************************************************************
...
-- Usage:
--   sqlplus sysadm/*******@SERVICE @export_delete_script_final6_SE.SQL <DB_NAME> <START_DATE> <END_DATE>
-- Example:
--   sqlplus sysadm/*******@FSSNDX    @export_delete_script_final6_SE.SQL FSSNDX 2025-12-01 2025-12-31
-- Notes:
