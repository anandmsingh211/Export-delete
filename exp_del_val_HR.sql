...
spool c:\temp\exp_del_val_HR.LOG
set echo on
set autocommit off
set feedback on
set time on
...
-- **********************************************************************
-- SQL Script File Name: exp_del_val_HR.SQL
-- **********************************************************************
...
-- Usage:
--   sqlplus sysadm/*******@SERVICE @exp_del_val_HR.SQL <DB_NAME> <START_DATE> <END_DATE>
-- Example:
--   sqlplus sysadm/*******@FSSNDX    @exp_del_val_HR.SQL HRSNDX 2025-12-01 2025-12-31
-- Notes:
