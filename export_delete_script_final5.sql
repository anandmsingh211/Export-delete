...
spool c:\temp\export_delete_script_final5.LOG
set echo on
set autocommit off
set feedback on
set time on
...
-- **********************************************************************
-- SQL Script File Name: export_delete_script_final5.SQL
-- **********************************************************************
...
-- =========[ Runtime Prompts ]=========
prompt
prompt Enter purge window dates (format: YYYY-MM-DD). End date is inclusive.
accept p_start_date char prompt 'Start Date (YYYY-MM-DD): '
accept p_end_date   char prompt 'End   Date (YYYY-MM-DD): '

prompt
accept p_target_db char prompt 'Target DB Name (must match current DB): '
