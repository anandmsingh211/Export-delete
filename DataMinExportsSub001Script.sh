...
EXPORTFILESRC=/oggdata/EHUB_EXPORT/DATA_MIN_EXPORTS/ExportInputParams
...
echo 'Template Where Condition   : ' $TEMPLATE_VAR
...
do 
   ...
   #-----------------------------------------------------------------------------------#
   #SR10242024#CURR_TEMPLATE=${TMPLARR[$x][3]}
   CURR_TEMPLATE="${TMPLARR[$x][3]}"
   #SR10242024#HIST_RECORD=${TMPLARR[$x][4]}
