...
spool /backup/exa_ps/dba/PS_Archival/LOG/Del_extra_validation12.LOG
SET ECHO OFF
SET AUTOCOMMIT OFF
SET FEEDBACK OFF
SET TIME ON
...
-- **********************************************************************
-- SQL Script File Name: Del_extra_validation12.SQL
-- **********************************************************************
-- 
-- Description:
...
DECLARE
  ...
  -- UPDATED: Now accepts MM/DD/YYYY directly to match your input (05/01/2023)
  ...
  -- (Removed ampersand to prevent input prompt)
